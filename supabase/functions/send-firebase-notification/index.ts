...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="url" id="promotionUrl" placeholder="https://mancool.netlify.app/notifications.html" value="https://mancool.netlify.app/notifications.html">
        </div>
        <div class="form-group">
    ...
    <script>
        ...
        function clearForm() {
            ...
            document.getElementById('promotionUrl').value = 'https://mancool.netlify.app/notifications.html';
