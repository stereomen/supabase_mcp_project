...
def find_closest_station_and_merge():
    ...
    output_file = os.path.join(script_dir, 'tide-abs_info_ab.csv')
    ...
    new_fieldnames_b = ['b_STN ID', 'b_위도(LAT)', 'b_경도(LON)', 'b_제공 정보']
...
if __name__ == "__main__":
    find_closest_station_and_merge()