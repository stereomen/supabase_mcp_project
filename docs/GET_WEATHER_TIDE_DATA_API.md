...
```json
{
  ...
  "weatherapi": {
    "hourly": [
      {
        "observation_time_local": "2025-10-03T15:00:00+09:00",
...
| 필드 | 타입 | 단위 | 설명 |
|------|------|------|------|
| `observation_time_local` | string | - | 예보시간 (현지시간) |
...
| `wind_mph` | number | mph | 풍속 (마일/시) |
| `wind_kph` | number | km/h | 풍속 (킬로미터/시) |
| `wind_degree` | number | deg | 풍향 각도 (0-360도) |
| `wind_direction` | string | - | 풍향 방향 (N, NE, E, SE, S, SW, W, NW) |
| `gust_mph` | number | mph | 돌풍 (마일/시) |
| `gust_kph` | number | km/h | 돌풍 (킬로미터/시) |
